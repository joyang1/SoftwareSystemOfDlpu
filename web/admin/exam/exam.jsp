...
<html>
    ...
    <body background="<%=cp%>/img/bg1.jpg">
        ...
        <br/><br/><br/>
        <form action="<%=cp%>/ExamServlet" method="post" enctype="multipart/form-data" class="form-signin">
            <h2 class="form-signin-heading">添加试卷</h2>
            <input type="text" name="title" class="input-block-level" placeholder="试卷名"><br/>
            <textarea  name="introduce" class="input-block-level" placeholder="试卷介绍"></textarea>
